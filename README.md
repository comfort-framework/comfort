...
| Coverage Data (Java)     | -                            | x (method-level)    | -                             | x (class-level, method-level) | x (class-level, method-level) | -                             | -                              | x (method-level)      | x (method-level)                  | -                             | x (class-level, method-level) |
| Coverage Data (Python)   | -                            | x (method-level)    | -                             | x (class-level, method-level) | x (class-level, method-level) | -                             | -                              | -                     | x (method-level)                  | -                             | x (class-level, method-level) |
