...
import de.ugoe.cs.seppelshark.data.models.JavaClass;
import de.ugoe.cs.seppelshark.data.models.JavaMethod;
import de.ugoe.cs.seppelshark.data.models.PythonMethod;
import de.ugoe.cs.seppelshark.data.models.PythonModule;
...
public class BaseTest {
    ...
    // Java Coverage Data
    protected JavaMethod testMethodThatCallsOtherMethod = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage", "MethodThatCallsOtherMethodTest", "testMethodThatCallsOtherMethod", new ArrayList<>(),
            Paths.get("src/test/java/de/ugoe/cs/seppelshark/codecoverage/MethodThatCallsOtherMethodTest.java"));
    protected JavaMethod testCallToSubClassMethod = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage", "CallsSubClassMethodTest", "testCallToSubClassMethod", new ArrayList<>(),
            Paths.get("src/test/java/de/ugoe/cs/seppelshark/codecoverage/CallsSubClassMethodTest.java"));
    protected JavaMethod testSameMethodTested = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage", "SameMethod1Test", "testSameMethod", new ArrayList<>(),
            Paths.get("src/test/java/de/ugoe/cs/seppelshark/codecoverage/SameMethod1Test.java"));
    protected JavaMethod sameMethod2Test = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage", "SameMethod2Test", "testSameMethod", new ArrayList<>(),
            Paths.get("src/test/java/de/ugoe/cs/seppelshark/codecoverage/SameMethod2Test.java"));
    protected JavaMethod testSameMethodInDifferentClasses = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage", "SameMethodInDifferentClassesTest", "testSameMethodInDifferentClasses", new ArrayList<>(),
            Paths.get("src/test/java/de/ugoe/cs/seppelshark/codecoverage/SameMethodInDifferentClassesTest.java"));
    protected JavaMethod test1 = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage", "WithDifferentMethodsCallDifferentMethodsTest", "test1", new ArrayList<>(),
            Paths.get("src/test/java/de/ugoe/cs/seppelshark/codecoverage/WithDifferentMethodsCallDifferentMethodsTest.java"));
    protected JavaMethod test2 = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage", "WithDifferentMethodsCallDifferentMethodsTest", "test2", new ArrayList<>(),
            Paths.get("src/test/java/de/ugoe/cs/seppelshark/codecoverage/WithDifferentMethodsCallDifferentMethodsTest.java"));
    protected JavaMethod withDifferentMethodsCallSameMethodTest = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage", "WithDifferentMethodsCallSameMethodTest", "test1", new ArrayList<>(),
            Paths.get("src/test/java/de/ugoe/cs/seppelshark/codecoverage/WithDifferentMethodsCallSameMethodTest.java"));
    protected JavaMethod withDifferentMethodsCallSameMethodTest2 = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage", "WithDifferentMethodsCallSameMethodTest", "test2", new ArrayList<>(),
            Paths.get("src/test/java/de/ugoe/cs/seppelshark/codecoverage/WithDifferentMethodsCallSameMethodTest.java"));
    protected JavaMethod ifInMethodTest = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage", "IfInMethodTest", "test1", new ArrayList<>(),
            Paths.get("src/test/java/de/ugoe/cs/seppelshark/codecoverage/IfInMethodTest.java"));
    protected JavaMethod callMethodWithSameParameterFromDifferentPackagesTest = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage", "CallMethodWithSameParameterFromDifferentPackagesTest", "test1", new ArrayList<>(),
            Paths.get("src/test/java/de/ugoe/cs/seppelshark/codecoverage/CallMethodWithSameParameterFromDifferentPackagesTest.java"));
    protected JavaMethod M1SubclassInit = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage", "Module1$SubClassModule1", "<init>", new ArrayList<>(),
            Paths.get("src/main/java/de/ugoe/cs/seppelshark/codecoverage/Module1.java"));
    protected JavaMethod M1SubclassSum = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage", "Module1$SubClassModule1", "sum", new ArrayList<String>(){{add("int"); add("int");}},
            Paths.get("src/main/java/de/ugoe/cs/seppelshark/codecoverage/Module1.java"));
    protected JavaMethod Module1Init = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage", "Module1", "<init>", new ArrayList<>(),
            Paths.get("src/main/java/de/ugoe/cs/seppelshark/codecoverage/Module1.java"));
    protected JavaMethod Module1Sum = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage", "Module1", "sum", new ArrayList<String>(){{add("int"); add("int");}},
            Paths.get("src/main/java/de/ugoe/cs/seppelshark/codecoverage/Module1.java"));
    protected JavaMethod Module2module1Call = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage", "Module2", "module1Call", new ArrayList<String>(){{add("int"); add("int");}},
            Paths.get("src/main/java/de/ugoe/cs/seppelshark/codecoverage/Module2.java"));
    protected JavaMethod Module2Sum = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage", "Module2", "sum", new ArrayList<String>(){{add("int"); add("int");}},
            Paths.get("src/main/java/de/ugoe/cs/seppelshark/codecoverage/Module2.java"));
    protected JavaMethod Module3BiggerThan = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage", "Module3", "biggerThan", new ArrayList<String>(){{add("java.lang.Integer"); add("java.lang.Integer");}},
            Paths.get("src/main/java/de/ugoe/cs/seppelshark/codecoverage/Module3.java"));
    protected JavaMethod Module3CompareModule = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage", "Module3", "compareModule", new ArrayList<String>(){{add("de.ugoe.cs.seppelshark.codecoverage.Module4"); add("de.ugoe.cs.seppelshark.codecoverage.pkg.Module4");}},
            Paths.get("src/main/java/de/ugoe/cs/seppelshark/codecoverage/Module3.java"));
    protected JavaMethod Module3CompareModule2 = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage", "Module3", "compareModule", new ArrayList<String>(){{add("de.ugoe.cs.seppelshark.codecoverage.Module4"); add("de.ugoe.cs.seppelshark.codecoverage.Module4");}},
            Paths.get("src/main/java/de/ugoe/cs/seppelshark/codecoverage/Module3.java"));
    protected JavaMethod Module4Init = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage", "Module4", "<init>", new ArrayList<>(),
            Paths.get("src/main/java/de/ugoe/cs/seppelshark/codecoverage/Module4.java"));
    protected JavaMethod Module4PkgInit = new JavaMethod("de.ugoe.cs.seppelshark.codecoverage.pkg", "Module4", "<init>", new ArrayList<>(),
            Paths.get("src/main/java/de/ugoe/cs/seppelshark/codecoverage/pkg/Module4.java"));
