...
public class ChangeSetLoaderTest extends BaseTest {
    ...
    private final static String DB_NAME = "comfortTest";
    ...
    public void setUpDatabase() {
        ...
        // Generate vcsSystem
        final VCSSystem vcsSystem = new VCSSystem("http://github.com/comfort-framework/comfort", projectId, "git", new Date());
