...
import de.ugoe.cs.seppelshark.filer.IFiler;
...
public class GeneralConfiguration {
    ...
    private String logFile = "/tmp/seppelshark.out";
    ...
    public IFiler getFiler() throws ClassNotFoundException, IllegalAccessException,
        ...
        IFiler filer = (IFiler) Class.forName("de.ugoe.cs.seppelshark.filer." + this.filerConfiguration.getName())
                .newInstance();
